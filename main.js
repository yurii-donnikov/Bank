...
<div class="popupWindow">
  ...
  <div class="modalWindow">
    <input type="text" placeholder="name" data-id="name" class="input">

    <label for="isActive">Active?</label>
    <input type="radio" id="isActive" data-id="isActive" class="input">
    <div class="debetCard">
      <p>Debet</p>

      <input type="number" placeholder="balance" class="input" data-id="balanceDebet">

      <label for="isActiveDebet">Active card?</label>

      <input type="radio" id="isActiveDebet" class="input" data-id="isActiveDebet">

      <select class="input" data-id="currencyDebet">
        <option>UAH</option>
        <option>EUR</option>
        <option>RUB</option>
        <option>PLN</option>
    ...
    <div class="creditCard">
      ...
      <input type="number" placeholder="balance" class="input" data-id="balanceCredit">

      <input type="number" placeholder="limit" class="input" data-id="limitCredit">

      <label for="isActiveCredit">Active card?</label>
      <input type="radio" id="isActiveCredit" class="input" data-id="isActiveCredit">

      <select class="input" data-id="currencyCredit">
        <option>UAH</option>
        <option>EUR</option>
        <option>RUB</option>
        <option>PLN</option>
...
function changeCard() {
  console.log(indexActiveCard)
    ...
    //  console.log(document.getElementsByClassName(allInput[i].getAttribute('data-id'))[indexActiveCard])
    if(allInput[i].type === 'radio') {
      document.getElementsByClassName(allInput[i].getAttribute('data-id'))[indexActiveCard].innerHTML = allInput[i].checked;
    //  bank.clients[indexActiveCard].
