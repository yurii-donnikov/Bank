                    ...
                    for(let j = 0; j < itemСheck.children.length; j++) {
                        if(itemСheck.children[j].type === 'radio'){
                            let nameClass = itemСheck.children[j].className;
                                ...
                                document.getElementsByClassName(itemСheck.children[j].getAttribute('data-id'))[indexActiveCard].innerText = itemСheck.children[j].checked;
                            ...
                            if(itemСheck.children[j].value) {
                                if(itemСheck.children[j].valueAsNumber) {
                                    let nameClass = itemСheck.children[j].className;
                                        ...
                                        document.getElementsByClassName(itemСheck.children[j].getAttribute('data-id'))[indexActiveCard].innerText = itemСheck.children[j].valueAsNumber;
                                        itemСheck.children[j].valueAsNumber = undefined;
                                } else {
                                    let nameClass = itemСheck.children[j].className;
                                    bank.clients[indexActiveCard].checks[i][nameClass] = itemСheck.children[j].value;
                                    document.getElementsByClassName(itemСheck.children[j].getAttribute('data-id'))[indexActiveCard].innerText = itemСheck.children[j].value;
                                }
                            }
                        }
                    }
